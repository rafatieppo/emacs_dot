...
(custom-set-variables
 ...
 '(package-selected-packages
   '(smex smartparens py-autopep8 powerline polymode multiple-cursors markdown-mode jedi indent-guide ido-vertical-mode ido-hacks highlight-symbol flx-ido ess elpy csv-mode auctex ace-jump-mode ac-math)))
