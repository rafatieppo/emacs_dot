...
(let ((class '((class color) (min-colors 89)))
  ...
  '(markdown-header-face-1 ((t (:inherit markdown-header-face :foreground "#5b94ab" :weight bold))))
  '(markdown-header-face-2 ((t (:inherit markdown-header-face :foreground "#5b94ab" :weight bold))))
  '(markdown-header-face-3 ((t (:inherit markdown-header-face :foreground "#5b94ab" :weight bold))))
  '(markdown-header-face-4 ((t (:inherit markdown-header-face :foreground "#5b94ab" :weight bold))))
  '(markdown-header-face-5 ((t (:inherit markdown-header-face :foreground "#5b94ab" :weight bold))))
  '(markdown-header-face-6 ((t (:inherit markdown-header-face :foreground "#5b94ab" :weight bold))))
