...
(defcustom solarized-height-plus-1 1.0 ;;1.1
  "Font size +1."
  :type 'number
  :group 'solarized)

(defcustom solarized-height-plus-2 1.1 ;;1.15
  "Font size +2."
  :type 'number
  :group 'solarized)

(defcustom solarized-height-plus-3 1.1 ;;1.2
  "Font size +3."
  :type 'number
  :group 'solarized)

(defcustom solarized-height-plus-4 1.15 ;;1.3
  "Font size +4."
  :type 'number
  :group 'solarized)
