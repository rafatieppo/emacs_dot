...
(deftheme granger "Light table theme for Emacs")
  ...
  (custom-theme-set-variables
    'granger
    '(linum-format " %1i ")) ;; it was 5

  (let ((background "#2b303b") ;; it was #111013
        (selection  "#11253A"))
...
;; *****************************************************************************************
   ...
   `(fringe                           ((t (:background "#2f2f2f"   :foreground "#ffffff")))) ;; :background "#2f2f2f"   :foreground "#ffffff"
   `(linum                            ((t (:background ,background :foreground "#66662f")))) ;; :background ,background :foreground "#2f2f2f"
   `(minibuffer-prompt                ((t (:foreground "#9489C4"            :weight bold))))
   `(minibuffer-message               ((t (:foreground "#ffffff"                        ))))
   `(mode-line                        ((t (:foreground "#101112" :background "#53585B"  )))) ;; :foreground "#FFFFFF" :background "#484879"
...
;; *****************************************************************************************
   ...
   `(font-lock-comment-face           ((t (:foreground "#53585B")))) ;; #496b83
   `(font-lock-comment-delimiter-face ((t (:foreground "#53585B")))) ;; #666688
