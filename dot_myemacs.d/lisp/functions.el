...
(insert (make-string 0 ? ) "#+BEAMER_HEADER: \\setbeamercolor{title in head/foot}{bg=gray!35,fg=black}\n")
...
(insert (make-string 0 ? ) "#+BEAMER_HEADER: \\setbeamercolor{subsubsection in head/foot}{bg=red,fg=white}\n")
